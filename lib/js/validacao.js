document.addEventListener("DOMContentLoaded", function () {
    ...
    async function verificarExistencia(campo, valor, id = null) {
    ...
    cpfInput.addEventListener("blur", async function () {
        ...
        if (cpf !== "") {
            const existe = await verificarExistencia("cpf", cpf, id);
    ...
    emailInput.addEventListener("blur", async function () {
        ...
        if (email !== "") {
            const existe = await verificarExistencia("email", email, id);
    ...
    form.addEventListener("submit", async function (event) {
        ...
        const cpfExiste = await verificarExistencia("cpf", cpf, id);
        const emailExiste = await verificarExistencia("email", email, id);
